...
ax.text(0.12, latency_y - 0.12, "• p999:   <2 µs    (worst case in 1000)", fontsize=12, 
        va='top', family='monospace')
...
ax.text(0.1, rss_y, "RSS Stability:", fontsize=14, fontweight='bold', 
        va='top', family='monospace')
ax.text(0.12, rss_y - 0.04, "• Steady-state: 0% growth (100 churn cycles)", fontsize=12, 
        va='top', family='monospace', color='#27ae60', fontweight='bold')
ax.text(0.12, rss_y - 0.08, "• Long-term:    2.4% growth (1000 cycles)", fontsize=12, 
        va='top', family='monospace')
ax.text(0.12, rss_y - 0.12, "• Baseline RSS: +37% vs malloc (trade-off)", fontsize=12, 
        va='top', family='monospace')
...
ax.text(0.1, reclaim_y, "Epoch-Scoped RSS Reclamation:", fontsize=14, fontweight='bold', 
        va='top', family='monospace')
ax.text(0.12, reclaim_y - 0.04, "• API: epoch_close() for lifetime boundaries", fontsize=12, 
        va='top', family='monospace')
ax.text(0.12, reclaim_y - 0.08, "• Mechanism: madvise(MADV_DONTNEED) on empty slabs", fontsize=12, 
        va='top', family='monospace')
ax.text(0.12, reclaim_y - 0.12, "• Result: 19.15 MiB reclaimable, 100% cache reuse", fontsize=12, 
        va='top', family='monospace', color='#27ae60', fontweight='bold')

# Space Efficiency
space_y = 0.34
ax.text(0.1, space_y, "Space Efficiency:", fontsize=14, fontweight='bold', 
        va='top', family='monospace')
ax.text(0.12, space_y - 0.04, "• Average: 88.9% (11.1% internal fragmentation)", fontsize=12, 
        va='top', family='monospace')
ax.text(0.12, space_y - 0.08, "• Waste:   Comparable to malloc (15-25%)", fontsize=12, 
        va='top', family='monospace')
